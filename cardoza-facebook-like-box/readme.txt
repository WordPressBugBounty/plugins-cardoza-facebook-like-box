...
if you have any queries post it at https://johnn.info/

== Change Log === Version 4.7 =1. Remove empty lines at end to prevent headers already sent.= Version 4.6 =1. Added data tab options for facebook page.2. Optimize the shortcode settings= Version 4.5 =1. Optimize Widget Implemention.2. Fixed Minor css Issues= Version 4.1 =1. Fixed Security Bugs.= Version 3.1 =1. Added the tabs section[timeline,events,message]2. Added the popup advanced settings such as show on home page only,show for logged in visitor etc.= Version 3.0 =1. New Feature:  Added Facebook Popup [Lightbox] modal
